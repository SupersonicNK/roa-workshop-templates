...
### Installation
1. [**Download the initialization user event here**](https://raw.githubusercontent.com/SupersonicNK/roa-workshop-templates/master/advanced-skin-handler/scr/user_event15.gml). Rename it to any user_event between 0 and 15 that you aren't already using and put it into your `scripts` folder.
